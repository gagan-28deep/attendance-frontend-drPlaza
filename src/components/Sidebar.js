...
const Sidebar = () => {
  return (
    <aside class="flex flex-col w-64 h-52 px-5 py-3  bg-white">
      <div class="flex flex-col mt-4">
        <nav class="flex-1 -mx-3 space-y-3">
          ...
          >
            ...
            <span class="mx-2 text-sm font-medium">Attendance</span>
          </Link>
          {/* Uploads */}
          <Link
            to="/uploads"
          ...
          >
            ...
            <span class="mx-2 text-sm font-medium">File Uploads</span>
          </Link>
          <Link
            to="/all-users"
            class="flex items-center px-3 py-2 text-gray-600 transition-colors duration-300 transform rounded-lg dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 dark:hover:text-gray-200 hover:text-gray-700"
          ...
          >
            ...
            <span class="mx-2 text-sm font-medium">All Files</span>
          </Link>
        </nav>
      </div>
    </aside>
